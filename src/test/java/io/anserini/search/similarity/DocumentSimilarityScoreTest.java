...
public class DocumentSimilarityScoreTest extends BaseFeatureExtractorTest<String> {
  ...
  public void checkVariousDocumentsWithBM25Similarity() {
    Assert.assertEquals(0.322f, sim().bm25Similarity("cat", idOf(DOC_1)), delta);
    Assert.assertEquals(0.209f, sim().bm25Similarity("cat", idOf(DOC_2)), delta);
    Assert.assertEquals(0.0f, sim().bm25Similarity("dog", idOf(DOC_3)), delta);
    Assert.assertEquals(0.582f, sim().bm25Similarity("dog", idOf(DOC_4)), delta);
  }

  @Test
  public void checkVariousDocumentsWithBM25SimilarityWithRM3() {
    Assert.assertEquals(0.161f, sim().bm25SimilarityRm3("cat", idOf(DOC_1)), delta);
    Assert.assertEquals(0.104f, sim().bm25SimilarityRm3("cat", idOf(DOC_2)), delta);
    Assert.assertEquals(0.0f, sim().bm25SimilarityRm3("dog", idOf(DOC_3)), delta);
    Assert.assertEquals(0.291f, sim().bm25SimilarityRm3("dog", idOf(DOC_4)), delta);
  }
