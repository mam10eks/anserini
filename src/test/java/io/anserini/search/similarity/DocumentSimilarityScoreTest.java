...
public class DocumentSimilarityScoreTest extends BaseFeatureExtractorTest<String> {
  ...
  public void checkVariousDocumentsWithBM25Similarity() {
    Assert.assertEquals(0.14939f, bm25Similarity(reader(), "cat", idOf(DOC_1)), delta);
    Assert.assertEquals(0.09910f, bm25Similarity(reader(), "cat", idOf(DOC_2)), delta);
    Assert.assertEquals(0.0f, bm25Similarity(reader(), "dog", idOf(DOC_3)), delta);
    Assert.assertEquals(0.76038f, bm25Similarity(reader(), "dog", idOf(DOC_4)), delta);
  }

  @Test
  public void checkVariousDocumentsWithBM25SimilarityWithRM3() {
    Assert.assertEquals(0.07469f, bm25SimilarityRm3(reader(), "cat", idOf(DOC_1)), delta);
    Assert.assertEquals(0.04955f, bm25SimilarityRm3(reader(), "cat", idOf(DOC_2)), delta);
    Assert.assertEquals(0.0f, bm25SimilarityRm3(reader(), "dog", idOf(DOC_3)), delta);
    Assert.assertEquals(0.38019f, bm25SimilarityRm3(reader(), "dog", idOf(DOC_4)), delta);
  }
